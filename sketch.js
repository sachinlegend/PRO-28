...
function setup() {
	...
	mango4 = new Mango(1290,300,30);
	mango5 = new Mango(1250,200,30);
	mango6 = new Mango(1120,200,30);
  mango7 = new Mango(1130,280,30);
  tree = new Tree(1200,680);
  ground = new Ground(0,680,4000,20);
	boy = new Boy(350,600);
	chain = new Chain(stone.body,{x:260, y:500});
...
function draw() {
  ...
  fill('yellow');
  textSize(24);
  text("PRESS SPACE TO PICK THE STONE AFTER A THROW", 200,200);
  ground.display();
  tree.display();
  boy.display();
  stone.display();
